...
// ⚠️ Función general para calcular hash de cualquier Blob (File es un Blob)
export async function calculateSHA256HashHexFromBlob(blob: Blob): Promise<string> {
...
// ✅ Mantengo tu función original, usando la general (File es un Blob)
export async function calculateSHA256HashHex(file: File): Promise<string> {
  return calculateSHA256HashHexFromBlob(file);
}
