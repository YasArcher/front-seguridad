...
const FileCard: FC<FileCardProps> = ({
  ...
  return (
    <div className={`flex flex-col md:flex-row gap-4 p-5 bg-white border-l-4 ${getBorderColor()} rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 ${className}`}>
      <div className="flex-shrink-0 flex items-center justify-center">
        <div className="bg-gray-50 p-3 rounded-lg">
          <img src={icon} alt={`${type} icon`} className="w-14 h-14 object-contain" />
        </div>
      </div>
